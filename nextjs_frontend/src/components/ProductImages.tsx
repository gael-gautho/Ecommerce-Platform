...
const ProductImages = (
  {main_image_url, other_images_urls}:{main_image_url:string, other_images_urls:string[]}
) => {
  const [index, setIndex] = useState(0);
  const all_images_urls = [main_image_url, ...(other_images_urls || [])];
  ...
  return (
    <div className="">
      ...
      <div className="flex justify-between gap-4 mt-8">
        {all_images_urls.map((url:string, i:number) => (
          <div
